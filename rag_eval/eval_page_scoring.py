...
Two generic add-ons (a cross-encoder reranker, a BM25 keyword retriever) both
lost on the held-out test, because they try to overrule a retriever that was
trained on this very data. This improvement goes the other way: it keeps the
trained model as the only judge, but listens to it more carefully.
